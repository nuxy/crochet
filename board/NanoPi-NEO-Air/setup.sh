...
FREEBSD_DTB=${FREEBSD_SYS}/modules/dtb/allwinner
IMAGE_SIZE=$((1000 * 1000 * 1000))

allwinner_dts_copy_config() {
	echo "Backing up existing DTB Makefile: ${FREEBSD_DTB}/Makefile.bak"

	mv ${FREEBSD_DTB}/Makefile ${FREEBSD_DTB}/Makefile.bak

	echo "Copying custom DTB Makefile: ${FREEBSD_DTB}/Makefile"

	cp ${BOARDDIR}/Makefile ${FREEBSD_DTB}
}
...
strategy_add $PHASE_POST_CONFIG allwinner_dts_copy_config
